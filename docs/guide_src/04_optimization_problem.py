...
#    \text{subject to} &  &  & l_{x_i} \le x_i \le u_{x_i} \qquad i=1,\ldots,n\\
#    & & & l_{g_i} \le g_i (x_1, \ldots , x_n, p_1, \ldots p_m ) \le u_{g_i} \qquad i=1,\ldots,\ell\\
#    \end{aligned}
#
# ..
#     .. math::
#        \begin{align}
#            &\underset{x}{\text{minimize}} & & f(x_1, \ldots, x_n, p_1, \ldots, p_m) & \\
