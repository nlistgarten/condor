...
class TableLookup(ModelTemplate):
    ...
    input = FreeField() #: the input of the model
    output = FreeField(Direction.output) #: the output of the model

    input_data = MatchedField(input)  #: vector of grid points for each input
    output_data = MatchedField(
        output
    )  #: grid of data for each output of shape generated by
