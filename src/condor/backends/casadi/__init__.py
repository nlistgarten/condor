...
from condor.backends.casadi.utils import flatten, wrap, tuple_to_symbol
import numpy as np
...
def symbol_generator(name, shape=(1,1), symmetric=False, diagonal=False, indexable=True):
