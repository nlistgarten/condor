...
class MPhbtf(pyc.MPCycle):
    ...
    def setup(self):
        ...
        self.pyc_add_pnt('OD_full_pwr', HBTF(design=False, thermo_method='TABULAR', throttle_mode='T4'))
        ...
        self.pyc_add_pnt('OD_part_pwr', HBTF(design=False, thermo_method='TABULAR', throttle_mode='percent_thrust'))
